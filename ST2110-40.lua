...
do
	...
	F.Section_Available =
		ProtoField.uint8("st_2110_40.Data.Section_Available", "Section Available", base.HEX, nil, 0xFF)
	...
	-- Spec: EN 300 472
	F.Field_Parity = ProtoField.bool(
		"st_2110_40.Data.Field_Parity",
		"Field Parity",
		8,
	...
	F.Magazine_Hamming =
		ProtoField.uint16("st_2110_40.Data.Magazine_Hamming", "Magazine (Hamming 8/4)", base.DEC, nil, 0xFC00)
	F.Magazine = ProtoField.uint8("st_2110_40.Data.Magazine", "Magazine", base.DEC, nil)
	F.PacketNumber_Hamming =
		ProtoField.uint16("st_2110_40.Data.PacketNumber_Hamming", "Packet Number (Hamming 8/4", base.DEC, nil, 0x3FF)
	F.PacketNumber = ProtoField.uint8("st_2110_40.Data.PacketNumber", "Packet Number", base.DEC, nil)
	F.PageUnits_Hamming =
		ProtoField.uint8("st_2110_40.Data.PageUnits_Hamming", "Page Units (Hamming 8/4)", base.HEX, nil, 0xFF)
	F.PageUnits = ProtoField.uint8("st_2110_40.Data.PageUnits", "Page Units", base.HEX, nil)

	F.PageTens_Hamming =
		ProtoField.uint8("st_2110_40.Data.PageTens_Hamming", "Page Tens (Hamming 8/4)", base.HEX, nil, 0xFF)
	...
	F.MagazineSerial =
		ProtoField.bool("st_2110_40.Data.MagazineSerial", "MagazineSerial", 8, { "Serial Mode", "Parallel Mode" }, 0x40)
	F.CharacterSet =
		ProtoField.uint8("st_2110_40.Data.CharacterSet", "Character Subset", base.DEC, NATIONAL_SUBSET, 0x15)
	...
	F.TimeCodeVitcLineDup =
		ProtoField.uint8("st_2110_40.Data.TimeCodeVITC.LineDup", "Duplication", base.BOOL, nil, 0x20)
	local VITC_VLD = {
	...
	F.TimeCodeVitcValidity =
		ProtoField.uint8("st_2110_40.Data.TimeCodeVITC.Validity", "TC Validity", base.DEC, VITC_VLD, 0x40)
	local VITC_PROC = {
	...
	F.TimeCodeVitcProcess =
		ProtoField.uint8("st_2110_40.Data.TimeCodeVITC.Process", "Process bit", base.DEC, VITC_PROC, 0x80)
	...
	function ProcessWstPacket(inBuf, subtree)
		...
		if packet_number == 0 then
			...
			local ttPage = bit32.bor(bit32.lshift(magazine, 8), bit32.lshift(page_tens, 4), page_units)
	...
	function st_2110_40.dissector(tvb, pinfo, tree)
		...
		for i = 1, ANC_Count do
			...
			if cs_received ~= cs_calc then
				...
				cs_item:add_expert_info(
					PI_CHECKSUM,
					PI_WARN,
					"The calculated ANC checksum and ANC checksum word do not match."
				)
			end
				...
				while s < CDP_size do
					...
					elseif CDPsection == 0x72 then
						...
						if buffer_size > 1 then
							if
								CC_concat:get_index(0) == 0x0D
								and CC_concat:get_index(1) == 0x90
								and CC_concat:get_index(4) == 0x91
							then
								-- do nothing
