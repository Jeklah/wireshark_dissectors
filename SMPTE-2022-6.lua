...
do
	...
	F.S = ProtoField.uint8(
		"smpte_2022_6.S",
		"Video Payload Scambling (S)",
		base.HEX,
		{ [0] = "not scrambled", [1] = "reserved", [2] = "reserved", [3] = "reserved" },
		0x30
	)
	...
	F.header_ext_tag =
		ProtoField.uint8("smpte_2022_6.header_ext_tag", "Header extension tag (header_ext_tag)", base.HEX)
	...
	F.HBRM_payload = ProtoField.bytes("smpte_2022_6.HBRM_payload", "HBRM payload")
